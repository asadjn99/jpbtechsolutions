...
export default function PageHero({ 
  ...
  return (
    <section className="relative w-full pt-36 pb-24 lg:pt-32 lg:pb-10 overflow-hidden bg-[#3b5d50]">
      
      {/* ================= DECORATIVE BACKGROUND LAYERS ================= */}
      
      {/* 1. The Green Curve */}
      <div className="absolute top-0 left-0 max-w-7xl h-137.5 bg-[#3e6053] rounded-br-[150px] z-0 lg:w-[60%] lg:rounded-br-[250px]" />
      ...
      <div className="absolute -bottom-32 -right-32 w-96 h-96 border-10 border-[#f9bf29]/90 opacity-15 rounded-full z-0 "/>
      <Plus className="absolute top-91 left-43 text-white/30 w-8 h-8 z-10 animate-spin-slow" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-16">
          ...
          >
            ...
            {/* Buttons (CONTACT VERSION) */}
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              <Link 
                href="#form" // form link
                className="relative group bg-white text-[#3b5d50] font-bold px-8 py-4 rounded-xl transition-all flex items-center justify-center gap-2 overflow-hidden shadow-lg"
              >
            ...
            {/* Trust Indicator (CONTACT VERSION) */}
          ...
          >
            ...
            <div className="absolute bottom-10 -left-2 sm:-left-6 bg-white p-5 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] z-20 animate-float-delayed">
               <div className="flex items-center gap-3 mb-1">
                   <p className="text-[#3b5d50] font-extrabold text-3xl">100%</p>
               </div>
               <p className="text-gray-500 text-xs font-bold uppercase tracking-wider">Response Rate</p>
            </div>
